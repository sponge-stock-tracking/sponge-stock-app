...
export function Sidebar({
  ...
  return (
    <>
      <aside className="w-[250px] h-screen flex flex-col text-[#C1E8FF]" style={{
          ...
          <div className="grid grid-cols-7 gap-1 text-center">
            ...
            {days.map((day) => (
              <div
                ...
                className={`text-sm py-1.5 rounded-md cursor-pointer transition-colors relative ${isToday(day)
