      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-6 space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-3xl font-bold tracking-tight">Stok Girişi</h2>
              <p className="text-muted-foreground mt-1">Yeni stok ekleyin</p>
            </div>
          </div>

          <div className="max-w-2xl">
            <StockForm type="giris" sungerler={sungerler} stokDurumlari={stokDurumlari} onSubmit={handleSubmit} />
          </div>
        </main>
      </div>
    </ProtectedRoute>
